...
import com.alibaba.csp.sentinel.dashboard.rule.nacos.gatewayApi.GareWayApiRule;
...
/**
 * MetricEsEntity for {@link ApiDefinition}.
 *
 * @author cdfive
 * @since 1.7.0
 */
public class ApiDefinitionEntity implements RuleEntity {
    ...
    @Override
    public GareWayApiRule toRule() {
        GareWayApiRule flowRule = new GareWayApiRule();
        flowRule.setApiName(this.apiName);
        flowRule.setPredicateItems(this.predicateItems);
        return flowRule;
    }
