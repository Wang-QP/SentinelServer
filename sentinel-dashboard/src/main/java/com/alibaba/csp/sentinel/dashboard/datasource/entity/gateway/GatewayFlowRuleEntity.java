...
import com.alibaba.csp.sentinel.dashboard.rule.nacos.gatewayFlow.GatewayFlowNacosRule;

import java.util.Date;
import java.util.Objects;

/**
 * MetricEsEntity for {@link GatewayFlowRule}.
 *
 * @author cdfive
 * @since 1.7.0
 */
public class GatewayFlowRuleEntity implements RuleEntity {
    ...
    @Override
    public GatewayFlowNacosRule toRule() {
        GatewayFlowNacosRule flowRule = new GatewayFlowNacosRule();
        ...
        flowRule.setInterval(this.interval);
        flowRule.setIntervalUnit(this.intervalUnit);
        flowRule.setMaxQueueingTimeoutMs(this.maxQueueingTimeoutMs);
        flowRule.setParamItem(this.paramItem);
